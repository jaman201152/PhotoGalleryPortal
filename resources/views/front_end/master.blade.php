                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div id="main-slider" class="main-slider flexslider">
                                <ul class="slides">
                                    <li>
                                        <img src="{{URL::to("public/front_end/img/slides/flexslider/1.jpg")}}" alt="" />
                                    ...
                                    <li>
                                        <img src="{{URL::to("public/front_end/img/slides/flexslider/2.jpg")}}" alt="" />
                                        <div class="flex-caption">
                                    ...
                                    <li>
                                        <img src="{{URL::to("public/front_end/img/slides/flexslider/3.jpg")}}" alt="" />
                                        <div class="flex-caption">
                                            <h3>Clean & Fast</h3>
