...
<div class="row-fluid sortable">		
    ...
    if ($v_category->publication_status == 1) {
        ?>
           <a class="btn btn-danger" href="{{URL::to('/unpublished-category/'.$v_category->category_id)}}" title="Unpublished">
                    <i class="halflings-icon white thumbs-down"></i>  
             </a>
        <?php
    } else {
        ?>
             <a class="btn btn-success" href="{{URL::to('/published-category/'.$v_category->category_id)}}" title="Published">
